...
then that illustrates the power of good outlining. You don't need a bunch of comments explaining the code. 
The code is effectively SELF-EXPLANATORY, even at this early, not-fully-implemented stage. 
...
Don't pseudocode functions, just write the functions as empty stubs. That saves you precious time later, with less rewriting.
...
console.log(findMaxRepeatCountInWord('chocolate'));
...
console.log(findFirstWordWithMostRepeatedChars('I like chocolate carbunkle'));